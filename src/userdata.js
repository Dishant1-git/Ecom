...
export const Userdata = () => {
    ...
    const getuser = async () => {
        ...
        const res = await fetch("https://ecom-five-xi.vercel.app/api/alluser", {
    ...
    const del= async(id)=>{
        ...
        const res= await fetch(`https://ecom-five-xi.vercel.app/api/deleteuser/${id}`,{
            method:"DELETE"
        });
        if(res.ok){
            const result=await res.json();
    ...
    const changeu = async (id, newType) => {
        const res = await fetch(`https://ecom-five-xi.vercel.app/api/updateuser/${id}`, {
            method: "PUT",
            headers: {

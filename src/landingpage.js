...
const[cname,setcname]=useState()
  ...
  latestproduct();
    ...
    try {
        const res = await fetch("https://ecom-five-xi.vercel.app/api/latestprod")
        if (res.ok) {
  ...
  return (
    <>
        ...
        <Slider {...settings} className="home-slider">
          <div>
            <a href="#" className="home">
              <img
                src="/assets/images/bbanner1.jpg"
                alt="Banner 1"
          ...
          <div>
            <a href="#" className="home">
              <img
                src="/assets/images/bbanner2.jpg"
                alt="Banner 2"
                className="bg-img blur-up lazyload"
                height="800px"
                width="100%"
      ...
      <section class="section-b-space pt-0 ratio_asos" >
        <div class="container title-inner1"  
        data-aos="fade-right"         
        data-aos-delay="100"       
        data-aos-duration="800"    
        data-aos-easing="ease-in-out" >
              ...
              <div class="basic-product theme-product-1">
                <div class="overflow-hidden">
                  <div class="img-wrapper">
                    ...
                    <a href="">
                      <img src={`uploads/${data.categorytype}`} class="img-fluid blur-up lazyload" alt="" />
                    </a>
      ...
      <section className="service-w-bg banner-padding theme-bg-service title-inner1"  data-aos="fade-right"         
        data-aos-delay="100"       
        data-aos-duration="800"    
        data-aos-easing="ease-in-out" >
        <div className="container">
          <div className="service p-0">
            <div className="row margin-default">
              ...
              <div className="col-lg-3 col-sm-6 service-block">
                <div className="media">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 480" width="512px" height="512px">
                    <g>
                      <g>
                        <g>
                          <path d="M472,432h-24V280c-0.003-4.418-3.588-7.997-8.006-7.994c-2.607,0.002-5.05,1.274-6.546,3.41l-112,160     c-2.532,3.621-1.649,8.609,1.972,11.14c1.343,0.939,2.941,1.443,4.58,1.444h104v24c0,4.418,3.582,8,8,8s8-3.582,8-8v-24h24     c4.418,0,8-3.582,8-8S476.418,432,472,432z M432,432h-88.64L432,305.376V432z"></path>
                          <path d="M328,464h-94.712l88.056-103.688c0.2-0.238,0.387-0.486,0.56-0.744c16.566-24.518,11.048-57.713-12.56-75.552     c-28.705-20.625-68.695-14.074-89.319,14.631C212.204,309.532,207.998,322.597,208,336c0,4.418,3.582,8,8,8s8-3.582,8-8     c-0.003-26.51,21.486-48.002,47.995-48.005c10.048-0.001,19.843,3.151,28.005,9.013c16.537,12.671,20.388,36.007,8.8,53.32     l-98.896,116.496c-2.859,3.369-2.445,8.417,0.924,11.276c1.445,1.226,3.277,1.899,5.172,1.9h112c4.418,0,8-3.582,8-8     S332.418,464,328,464z"></path>
                          <path d="M216.176,424.152c0.167-4.415-3.278-8.129-7.693-8.296c-0.001,0-0.002,0-0.003,0     C104.11,411.982,20.341,328.363,16.28,224H48c4.418,0,8-3.582,8-8s-3.582-8-8-8H16.28C20.283,103.821,103.82,20.287,208,16.288     V40c0,4.418,3.582,8,8,8s8-3.582,8-8V16.288c102.754,3.974,185.686,85.34,191.616,188l-31.2-31.2     c-3.178-3.07-8.242-2.982-11.312,0.196c-2.994,3.1-2.994,8.015,0,11.116l44.656,44.656c0.841,1.018,1.925,1.807,3.152,2.296     c0.313,0.094,0.631,0.172,0.952,0.232c0.549,0.198,1.117,0.335,1.696,0.408c0.08,0,0.152,0,0.232,0c0.08,0,0.152,0,0.224,0     c0.609-0.046,1.211-0.164,1.792-0.352c0.329-0.04,0.655-0.101,0.976-0.184c1.083-0.385,2.069-1.002,2.888-1.808l45.264-45.248     c3.069-3.178,2.982-8.242-0.196-11.312c-3.1-2.994-8.015-2.994-11.116,0l-31.976,31.952     C425.933,90.37,331.38,0.281,216.568,0.112C216.368,0.104,216.2,0,216,0s-0.368,0.104-0.568,0.112     C96.582,0.275,0.275,96.582,0.112,215.432C0.112,215.632,0,215.8,0,216s0.104,0.368,0.112,0.568     c0.199,115.917,91.939,210.97,207.776,215.28h0.296C212.483,431.847,216.013,428.448,216.176,424.152z"></path>
                          <path d="M323.48,108.52c-3.124-3.123-8.188-3.123-11.312,0L226.2,194.48c-6.495-2.896-13.914-2.896-20.408,0l-40.704-40.704     c-3.178-3.069-8.243-2.981-11.312,0.197c-2.994,3.1-2.994,8.015,0,11.115l40.624,40.624c-5.704,11.94-0.648,26.244,11.293,31.947     c9.165,4.378,20.095,2.501,27.275-4.683c7.219-7.158,9.078-18.118,4.624-27.256l85.888-85.888     C326.603,116.708,326.603,111.644,323.48,108.52z M221.658,221.654c-0.001,0.001-0.001,0.001-0.002,0.002     c-3.164,3.025-8.148,3.025-11.312,0c-3.125-3.124-3.125-8.189-0.002-11.314c3.124-3.125,8.189-3.125,11.314-0.002     C224.781,213.464,224.781,218.53,221.658,221.654z"></path>
                        </g>
                      </g>
                    </g>
                  </svg>
      ...
      <section class="blog gym-blog ratio3_2 slick-default-margin section-b-space">
        <div class="container">
          <div class="row">
            <div class="col-md-12 title-inner1"  data-aos="fade-right"         
        data-aos-delay="200"       
        ...
        data-aos-easing="ease-in-out">
            ...
            <div class="col-md-12" >
              <div class="slide-4 no-arrow title-inner1"   data-aos="fade-right"         
        data-aos-delay="200"       
        data-aos-duration="900"    
        data-aos-easing="ease-in-out" >
                <Slider {...blog}>
                  <div style={{ display: "flex", height: "400px", width: "600px", flexDirection: "row " }}>

                    <div class="basic-effect">
                      <div>
                        <img src="../assets/images/blog.jpg" class="img-fluid blur-up lazyload bg-img" alt="" />
                        <span></span>
                      </div>
                    </div>
                  ...
                  <div>
                    <a href="">
                      <div class="basic-effect">
                        <div>
                          <img src="../assets/images/blog1.jpg" class="img-fluid blur-up lazyload bg-img" alt="" />
                          <span></span>
                        </div>
                      </div>
                    </a>
                  ...
                  <div>
                    <a href="">
                      <div class="basic-effect">
                        <div>
                          <img src="../assets/images/blog2.jpg" class="img-fluid blur-up lazyload bg-img" alt="" />
                          <span></span>
                        </div>
                      </div>
                    </a>
                  ...
                  <div>
                    <a href="">
                      <div class="basic-effect">
                        <div>
                          <img src="../assets/images/blog4.jpg" class="img-fluid blur-up lazyload bg-img" alt="" />
                          <span></span>
                        </div>
                      </div>
                    </a>
...
<section class="addtocart_count ratio_square title-inner1"    data-aos="fade-right"         
        data-aos-delay="400"       
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title-basic">
                        <h2 class="title font-fraunces"><i class="ri-flashlight-fill"></i>Coustomer's Favourite</h2>
                      ...
                      <Slider {...pro}>
                        <div class="basic-product theme-product-7" >
                            ...
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s1.jpg" class="img-fluid blur-up lazyload"  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s2.jpg" class="img-fluid blur-up lazyload"  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s3.jpg" class="img-fluid blur-up lazyload"  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s4.jpg" class="img-fluid blur-up lazyload"  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s5.jpg" class="img-fluid blur-up lazyload"  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s6.jpg" class="img-fluid blur-up lazyload"  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s7.jpg" class="img-fluid blur-up lazyload "  alt=""/></a>
                        ...
                        <div class="basic-product theme-product-7">
                            <div class="img-wrapper" style={{height:"150px"}}>
                                <a href=""><img src="../assets/images/s8.jpg" class="img-fluid blur-up lazyload "   alt=""/></a>
    ...
    {/* latest product */}
     ...
     <div class="title1 section-t-space title-inner1"   data-aos="fade-right"         
        data-aos-delay="500"       
        data-aos-duration="1400"    
        data-aos-easing="ease-in-out">
        <h4>New Additions</h4>
        <h2 class="title-inner1"> latest Baked</h2>
      </div>

     <section class="section-b-space pt-0 ratio_asos title-inner1"   data-aos="fade-right"         
        data-aos-delay="500"       
        data-aos-duration="1400"    
        data-aos-easing="ease-in-out">
        <div class="container">
              ...
              <div class="basic-product theme-product-1">
                <div class="overflow-hidden">
                  <div class="img-wrapper">
                    <div class="ribbon"><span>Exclusive</span></div>
                    <a href="">
                      <img src={`uploads/${data.pimg}`} class="img-fluid blur-up lazyload" alt="" />
                    </a>

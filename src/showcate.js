                ...
                <div>
                   <div className="basic-product theme-product-1">
                    ...
                    <div className="product-detail">
                               ...
                               {/* <button className='btn btn-warning' style={{marginLeft:"20px"}}>Add</button>
                             <button className='btn btn-warning'  style={{marginLeft:"20px"}}>Update</button> */}
